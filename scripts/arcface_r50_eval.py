...
def main():
    ...
    ap.add_argument("--pairs",      default="/home/angkira/datasets/lfw/pairs.txt")
    ap.add_argument("--yunet",      default="/home/angkira/.local/share/doorman/models/face_detection_yunet_2023mar.onnx")
    ap.add_argument("--r50",        default="/home/angkira/datasets/models_eval/w600k_r50.onnx")
    ...
    ap.add_argument("--output",     default="/home/angkira/Home/doorman/docs/arcface_r50_eval.md")
